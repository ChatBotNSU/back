"""Unit tests for telegram-execution sender."""
...
@pytest.fixture
def sender_instance():
    """Create a fresh TelegramResponseSender instance."""
    TelegramResponseSender._instance = None
    return TelegramResponseSender()
...
class TestTelegramResponseSender:
    """Tests for TelegramResponseSender singleton and response handling."""

    # ==================== Singleton Tests ====================

    def test_singleton_creation(self, sender_instance):
        # When
        instance2 = TelegramResponseSender.get_instance()
    ...
    def test_singleton_get_instance_error(self):
        ...
        with pytest.raises(RuntimeError, match="not initialized"):
            TelegramResponseSender.get_instance()
