...
class ConditionNodeExecutor:
    async def execute(self, execution_state: RunTimeExecutionState, node: ConditionNode, chatbot: Chatbot):
        for branch in node.branches:
            ...
            try:
                left_variable = execution_state.variable_values[condition.variable_left]
                right_variable = execution_state.variable_values[condition.variable_right]
            except:
            ...
            if condition.operation == "==":
                if left_variable == right_variable:
                    execution_state.executing_node_id = branch.next_node_id
                    return
        ...
        execution_state.executing_node_id = node.default_next_node_id
